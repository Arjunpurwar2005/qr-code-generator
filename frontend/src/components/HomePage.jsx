          ...
          {token ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2.5 border-l border-slate-200 dark:border-[#2A3844] pl-3">
                <div className="w-8 h-8 rounded-full bg-rq-navy dark:bg-[#1A2530] text-white font-bold text-xs flex items-center justify-center shadow-xs ring-2 ring-orange-400/30 border border-transparent dark:border-[#2A3844]">
