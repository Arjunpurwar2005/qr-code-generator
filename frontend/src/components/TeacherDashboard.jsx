  ...
  return (
    <div className="bg-slate-50 font-sans text-slate-800 antialiased min-h-screen flex flex-col selection:bg-orange-100 selection:text-orange-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3 border-l border-slate-200 pl-4">
              ...
              <div className="w-9 h-9 rounded-full bg-rq-navy text-white font-bold flex items-center justify-center text-sm shadow-sm">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full flex-1 space-y-8">
        {/* Welcome Banner */}
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden">
          <div className="absolute top-0 right-0 w-80 h-80 bg-orange-50 rounded-full blur-3xl -z-0 pointer-events-none"></div>
          <div className="relative z-10 space-y-1">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 text-slate-700 text-xs font-semibold uppercase tracking-wider mb-1">
            ...
            <p className="text-slate-600 text-sm sm:text-base">
              Manage your classroom attendance in seconds.
            </p>
          </div>
              ...
              >
                <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-slate-50">
                  <div>
                    ...
                    <p className="text-slate-500 text-xs mt-0.5">Set up your class and generate a QR code.</p>
                  </div>
                  <button
                ...
                >
                  ...
                  <div className="space-y-1">
                    <label className="block text-xs font-bold uppercase tracking-wider text-slate-700">
                      Class / Subject Details <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      value={classId}
                  ...
                  <div className="space-y-1">
                    ...
                    >
                      <option value="">Standard Default Form (Roll No, Full Name)</option>
                      {templates.map((tmpl) => (
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-3">
                      <input
                        ...
                        required
                      />
                      <span className="text-xs text-slate-500">Allowed student radius from classroom center</span>
                    </div>
                  </div>
        ...
        <section className="space-y-4">
          ...
          {activeSession ? (
            <div className="bg-white rounded-2xl border-2 border-emerald-500/30 shadow-md p-6 sm:p-8 relative overflow-hidden">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-3 shrink-0">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 rounded-xl bg-rq-navy hover:bg-slate-800 text-white font-manrope font-bold text-sm shadow-md transition-all flex items-center gap-2 cursor-pointer"
                  >
                    <span className="material-symbols-outlined text-[18px]">qr_code_2</span>
                    <span>Open Live QR Screen</span>
                  </button>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 text-center space-y-4">
              ...
              <div className="max-w-md mx-auto space-y-1">
                <h3 className="font-manrope font-bold text-lg text-rq-navy">No active attendance</h3>
                <p className="text-slate-500 text-sm">
                  Start a session to generate a QR code for your class.
                </p>
              </div>
              <div>
                <button
                  onClick={() => setShowStartModal(true)}
                  className="px-6 py-2.5 rounded-xl bg-rq-navy hover:bg-slate-800 text-white font-manrope font-bold text-sm shadow-sm transition-all inline-flex items-center gap-2 cursor-pointer"
                >
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="font-manrope font-bold text-lg text-rq-navy flex items-center gap-2">
              <span className="material-symbols-outlined text-rq-orange">history</span>
          ...
          {pastSessions && pastSessions.length > 0 ? (
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 text-center space-y-4">
              ...
              <div className="max-w-md mx-auto space-y-1">
                <h3 className="font-manrope font-bold text-lg text-rq-navy">No attendance sessions yet.</h3>
                <p className="text-slate-500 text-sm">
                  Start your first session to see attendance records here.
                </p>
              </div>
              <div>
                <button
